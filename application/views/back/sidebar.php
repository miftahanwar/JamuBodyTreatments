  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li <?php if($this->uri->segment(2) == "layanan"){echo "class='active'";} ?>>
        <a href='#'><i class='fa fa-list'></i><span> Services </span><i class='fa fa-angle-left pull-right'></i></a>
        <ul class='treeview-menu'>
          <li <?php if($this->uri->segment(2) == "layanan" && $this->uri->segment(3) == "create"){echo "class='active'";} ?>><a href='<?php echo base_url('admin/layanan/create') ?>'><i class='fa fa-circle-o'></i> Tambah Layanan </a></li>
          <li <?php if($this->uri->segment(2) == "layanan" && $this->uri->segment(3) == ""){echo "class='active'";} ?>><a href='<?php echo base_url('admin/layanan') ?>'><i class='fa fa-circle-o'></i> Data Layanan </a></li>
        </ul>
      </li>
