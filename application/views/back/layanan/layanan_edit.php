        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <?php echo form_open_multipart($action);?>
                ...
                <div class="box-body">
                  <div class="form-group"><label>Nama Layanan</label>
                    <?php echo form_input($nama_layanan, $layanan->nama_layanan);?>
                  </div>
                  <div class="form-group"><label>Harga Per Jam</label>
                    <?php echo form_input($harga, $layanan->harga);?>
                  </div>
                  <div class="form-group"><label>Foto Sebelumnya</label><br>
                    <img src="<?php echo base_url('assets/images/layanan/'.$layanan->foto.'') ?>" width="300px" class="img-responsive"/>
                  </div>
                ...
                <?php echo form_input($id_layanan,$layanan->id_layanan);?>
