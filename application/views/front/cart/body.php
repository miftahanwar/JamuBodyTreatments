		...
		<div class="col-lg-12">
			...
			<form action="<?php echo base_url('cart/checkout') ?>" method="post">
							...
							<table id="datatable" class="table table-striped table-bordered">
								<thead>
									<tr>
										...
										<th style="text-align: center">Durations(hours)</th>
								...
								<tbody>
									...
									foreach ($cart_data as $cart) { ?>
										<tr>
											<td style="text-align:left"><?php echo $cart->nama_layanan ?></td>
											...
											<td style="text-align:center">
												...
												<input type="hidden" name="layanan[]" value="<?php echo $cart->layanan_id ?>">
												<input type="hidden" name="id_transdet[]" value="<?php echo $cart->id_transdet ?>">
												<input type="hidden" value="<?php echo $cart->layanan_id; ?>" class="layanan_id">
											</td>
											<td style="text-align:center">
				...
				<?php if (!empty($customer_data->id_trans)) { ?>
					<div class="row">
						<div class="col-lg-12">
							<?php if (!empty($cek_keranjang->layanan_id)) { ?>
		...
		<script type="text/javascript">
			...
			$(function() {
				...
				$('.tanggal').on('changeDate', function(ev) {
					...
					layanan_id_el = tanggal_el.parent().parent().find(".layanan_id");
