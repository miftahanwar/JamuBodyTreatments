		...
		<div class="col-md-8"><h1>SEMUA EVENT</h1><hr>
			<?php foreach($event_all as $event){ ?>
				...
				<a href="<?php echo base_url("event/$event->slug_event ") ?>">
					<?php
					if(empty($event->foto)) {echo "<img class='img-responsive' src='".base_url()."assets/images/no_image_thumb.png' style='height:auto;max-width:100%;'>";}
					else { echo " <img class='img-responsive' src='".base_url()."assets/images/event/".$event->foto.$event->foto_type."' style='height:auto;max-width:100%;'> "; }
					?>
				</a>
				<p>
